...
const AffirmCard = () => {
  ...
  return (
    <section
      className="flex flex-col h-min-screen  bg-gray-100  items-centerjustify-start min-h-screen "
      id="affirmation"
    >
      <div className="min-w-screen  bg-gray-100 flex items-center  mt-6  justify-center px-5 py-5">
        <div
          className="w-full mx-auto rounded-lg border border-e-red-300 bg-white shadow-lg px-10 pt-10 pb-10 text-gray-800"
