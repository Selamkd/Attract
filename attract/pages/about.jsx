...
const About = () => {
  return (
    <>
      <section>
        <Header />
        <div className="container-fluid mx-auto px-[5%] lg:px-[15%] py-16 bg-[#f9f9f9]">
          ...
          <div className="service-item grid  lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
            <div className="service-img text-center order-1 lg:order-[0]">
              <Image src={Breathe} alt="" className="w-[60%] h-auto mt-3" />
            </div>
            <div className="">
          ...
          <div className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
            ...
            <div className="service-img text-center">
              <Image src={Affirm} alt="" className="w-[70%] h-auto" />
            </div>
          </div>
          <div className="service-item grid lg:grid-cols-2 gap-10 mx-auto items-center justify-center">
            <div className="service-img text-center order-1 lg:order-[0]">
              <Image src={Journal} alt="" className="w-[70%] h-auto" />
            </div>
            <div className="service-info">
              <h2 className="text-2xl lg:text-4xl font-bold mb-3">
